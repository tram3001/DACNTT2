...
Route::get('/',[
    BranchController::class,'indexlogin'
]);
...
Route::middleware('checklogin')->group(function(){
        ...
        Route::name('staff')->group(function(){
            ...
            Route::post('/display_teacher',[
             ...
             Route::post('/delete_teacher',[
                BranchController::class,'delete_teacher'
            ]);
            //search hide teacher
    ...
    Route::name('class')->group(function(){
        ...
        Route::post('/delete_student_class',[
            StudentController::class,'delete_student_class'
        ]);
