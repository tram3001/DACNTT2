        ...
        <div class="row gy-3 overflow-hidden" style="margin-top:15px">
          <div class="col-12">
            ...
            <div class="form-floating mb-3" style="margin-top:5px">
              <input type="text" placeholder="Tên đăng nhập" name="name" id="name" class="form-control" style="font-size: 15px" placeholder="Tên đăng nhập" required >
              <label for="email" class="form-label" style="font-size: 15px">Tên đăng nhập</label>
            </div>
          </div>
          <div class="col-12" style="margin-top:5px">
            <a style="font-size:15px;font-weight:bold">
              <i class="fi fi-rr-key" style="font-size:16px"></i> Mật khẩu
            </a>
            <div class="form-floating mb-3" style="margin-top:5px">
              <input type="password" placeholder="Mật khẩu" name="password" id="password" class="form-control" value="" placeholder="Mật khẩu" required>
