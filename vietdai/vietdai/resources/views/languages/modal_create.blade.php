...
<form action="/delete_language" method="post" enctype="multipart/form-data" style="margin:auto" onsubmit="return validateCreate()">
    {{ csrf_field() }}
    <div class="modal fade text-left" id="deletelanguage{{$item->name}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" hidden value="{{$item->name}}" name="languages">
