             ...
             <div style="padding-top:30px;padding-right:30px">
                <div class="col1" style="padding-top:20px">
                   <h5>Lịch trong tuần của giáo viên</h5>
                        ...
                        @endif
                    <a class="link_a" href="/staff/detail/staff={{$teacher->id}}">Giáo viên: {{$teacher->name}}</a>
                            ...
                            <tbody >
                                ...
                                <tr >
                                    ...
                                    for($j=2;$j<9;$j++){ 
                                        $key='T'.''.$j.''.'C'.''.$i;                                     
                                        ?>
                                        <td style="padding: 0px;  padding-bottom:0px;padding-top:0px;height:50px" >
                                            <?php
                                            ...
                                            if($a!=''){
                                                ...
                                                foreach ($class as $row) {
                                                    ...
                                                    if($calendar!=''){$c=1;
                                                    ?>
                                                        <a href="/class/detail_class/class={{$row->id}}" style="font-size: 10px;"><br>                                                                
                                                            {{$row->malop}}
                                                        </a>                                                                 
                                                    ...
                                                    ?>
                                                    <div style="color: white;background:{{$color}};width:100%; height:100%;padding-bottom:15px;padding-top:10px;margin:0px;text-align:center"  >
